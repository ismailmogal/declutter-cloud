...
const Feature: React.FC<{ icon: React.ReactNode; title: string; description: string }> = ({ icon, title, description }) => (
  <Paper elevation={2} sx={{ p: 3, textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
    ...
    <Box sx={{ bgcolor: 'grey.50', minHeight: '100vh', py: 6 }}>
      <Container maxWidth="lg">
        ...
        <Box sx={{ textAlign: 'center', my: 10 }}>
          ...
          <Button variant="contained" size="large" onClick={onLoginClick} sx={{ py: 1.5, px: 4 }}>
